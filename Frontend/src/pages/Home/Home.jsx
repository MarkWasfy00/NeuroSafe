...
const Home = () => {
  ...
  useEffect(() => {
    if (menu) {
      gsap.to(menuRef.current, {  top: "-8rem", right: "-8rem", duration: .5, ease: 'sine.out',})
      ...
      gsap.to(menuRef.current, { top: "-30rem", right: "-30rem", duration: .5, ease: 'power3.out',})
  ...
  return (
    <>
      <main className={styles.container}>
          ...
          <div className={styles.profilebar}>
            ...
            <div className={styles.notifier} >
              ...
              <div ref={menuRef} className={`${styles.circle} `}>
                ...
                <div ref={itemsRef} className={styles.itmlogout} onClick={() => { setLogout(true); setMenu(false) }}>
                  ...
                  <div className={styles.stressinfo}>
                    ...
                    <div className={styles.stressimg}>
                      <div className={styles.stresstitle}>
                        <div className={styles.left}>Stress</div>
                        <div className={styles.right}>Level</div>
                      </div>
        ...
        <div ref={shadowRef}  className={`${styles.backshadow} ${menu || logout ? styles.on : null}`} onClick={() => closeMenu()}></div>
      </main>
